...
export const ROUTES = {
    ...
    EVENT_LANDING_PAGE: "/events/landing-pages",
    EVENT_LANDING_PAGE_CREATE: "/events/landing-pages/create",
...
export const PRIVATE_ROUTES = [
    ...
    ROUTES.CLIENTS,
    ROUTES.EVENT_LANDING_PAGE,
    ROUTES.EVENT_LANDING_PAGE_CREATE,
...
export const AppRoutesPermissions = [
    ...
    { path: ROUTES.EVENT_LANDING_PAGE, permissions: [] },
    { path: ROUTES.EVENT_LANDING_PAGE_CREATE, permissions: [] },
    ...
    { path: ROUTES.POSTS, permissions: ["post:view"] },
    { path: ROUTES.POSTS_CREATE, permissions: ["post:create"] },
