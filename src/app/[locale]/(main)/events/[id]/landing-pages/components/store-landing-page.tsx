...
interface StoreLandingPageComponentProps {
    defaultData: ILandingPageRes | null;
}
export default function StoreLandingPageComponent({ defaultData }: StoreLandingPageComponentProps) {
    // ** I18n
    ...
    const titlePage = defaultData ? translation("landingPage.edit.title") : translation("landingPage.create.title");
    const messageSuccess = defaultData
        ? translation("successApi.UPDATE_LANDING_PAGE_SUCCESS")
        : translation("successApi.CREATE_LANDING_PAGE_SUCCESS");
    const messageError = defaultData
        ? translation("errorApi.UPDATE_LANDING_PAGE_FAILED")
        : translation("errorApi.CREATE_LANDING_PAGE_FAILED");
    ...
    const resetDataForm: LandingPageValues = {
        name: "",
        slug: "",
        title: "",
        subtitle: "",
